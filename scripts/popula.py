...
logging.basicConfig()
logger = logging.getLogger("trepr.intranet.popula")
...
AREAS = {
    "/estrututura": {
        ...
        "@type": "Document",
        "title": "Áreas",
        "description": "Áreas do TRE-PR",
    },
    "/colaboradores": {
        "id": "colaboradores",
        "@type": "Document",
        "title": "Colaboradores",
        "description": "Colaboradores do TRE-PR",
    },
    "/estrututura/secom": {
        "id": "secom",
        "@type": "Area",
...
for idx in range(1, 500):
    ...
    data = {
        ...
        "cargo": cargo,
        "area": area,
        "telefone": f"4132130{idx:03d}",
        "email": f"{username}@tre-pr.jus.br",
    }
    path = data["id"]
